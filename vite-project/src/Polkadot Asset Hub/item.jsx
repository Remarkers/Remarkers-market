...
console.log('Polkadot Address:', polkadotAddress);
    ...
    const getData = async (value) => {
        try {
            const response = await Axios.get(`https://asset-hub-indexer.vercel.app/itemData?data=${IdData}&image=${image}&page=${active.toString()}&orderBy=${value === "Recently Minted"? "blockNumber_DESC": value === "Earliest Minted"? "blockNumber_ASC": value === "Price Low To High"? "price_ASC" : value === "Price High To Low"? "price_DESC" : "blockNumber_DESC"}`);
